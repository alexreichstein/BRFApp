...
// Tryck på ett projekt för att redigera, långtryck för att radera
...
export default function ProjectsScreen() {
  // Fallback till tomma arrayer för att undvika undefined-fel vid laddning
  ...
  // Håller det projekt som redigeras — null betyder att vi skapar ett nytt
  ...
  // Öppnar modalen för att skapa nytt projekt
  const handleAdd = () => {
  ...
  // Öppnar modalen för att redigera befintligt projekt
  ...
  // Sparar nytt eller uppdaterat projekt till Firebase
  ...
  // Visar bekräftelsedialog och raderar projektet vid bekräftelse
  ...
  // Returnerar namnet på ansvarig medlem baserat på memberId
      ...
      <ScrollView style={styles.list}>
        {projects.length === 0 ? (
          ...
          projects.map((project) => (
            ...
            >
              {/* Färgad kant till vänster som visar projektstatus */}
              <View
                style={[
                  styles.statusBar,
                  { backgroundColor: STATUS_COLORS[project.status] ?? '#ccc' },
                ]}
              />
              ...
              <View style={styles.cardContent}>
                ...
                {/* Ansvarig medlem och budget */}
                <View style={styles.cardFooter}>
                  <Text style={styles.projectMember}>
                    👤 {getMemberName(project.memberId)}
                  </Text>
                  {project.budget ? (
                ...
                <View style={styles.chipRow}>
                  {members.map((m) => (
                    <TouchableOpacity
                      ...
                      style={[
                        styles.chip,
                        selectedMemberId === m.id && styles.chipActive,
                      ]}
                      onPress={() => setSelectedMemberId(m.id)}
                    >
                      <Text style={[
                        styles.chipText,
                        selectedMemberId === m.id && styles.chipTextActive,
                      ]}>
                        {m.name}
                      </Text>
                    </TouchableOpacity>
